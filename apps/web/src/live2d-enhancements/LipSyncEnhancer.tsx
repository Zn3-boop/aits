...
export class LipSyncEnhancer {
  ...
  private silentText = '';
  private silentSyllables: number[] = [];
  ...
  private startFrameLoop(): void {
    const update = () => {
      ...
      let form = 0; // MouthForm: -1=抿嘴/咧 0=中性 1=圆唇
  ...
  private startSilentFrameLoop(): void {
    const update = () => {
      ...
      const syllableWindow = 180; // 每个音节口型持续约180ms
      let openY = 0;
      let form = 0;
